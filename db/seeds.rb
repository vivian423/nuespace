...
first_seed = Listing.new(
  ...
  listing_description: 'Centrally located in Longyearbyen, Basecamp Hotel is a traditional trappers lodge-style property.'
)
# main picture
...
second_seed = Listing.new(
  listing_name: 'Clarion',
  listing_address: 'Kongsberg, Norway',
  listing_amenities: 'Free Wi_Fi, TV with cable',
  listing_description: 'Centrally located in Kongsberg,15 minutes away from tog station.'
)
  ...
  fourth_seed =Listing.new(
    ...
    listing_address: 'Halden, Norway',
    listing_amenities: 'Free Wi_Fi, TV with cable',
    listing_description: 'This hotel is situated on the island of Spitsbergen, in Norway Arctic Archipelago, Svalbard.'
  )
  ...
  fifth_seed =Listing.new(
    ...
    listing_amenities: 'Free Wi_Fi, TV with cable',
    listing_description: 'Radisson Blu Polar Hotel is the northernmost full-service hotel in the world, located in Oslo. Clean room, well positioned, enough dark curains to be able to sleep during midnight sun.'
   )
  ...
  file = URI.open("https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGhvdGVsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60.jpg")
    ...
    listing_amenities: 'Free Wi_Fi, TV with cable',
    listing_description: 'Located in Bergen and within 1.2 km of Svalbard Church, Russkiy Dom features a shared lounge, non-smoking rooms, and free WiFi. just quiet, comfortable and clean.'
  )
